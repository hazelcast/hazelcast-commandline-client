...
atomic-long commands are a group of atomic long operations.
...
Sets the value of the atomic long.
...
Increment the atomic long by the given value.
...
Decrement the atomic long by the given value.
