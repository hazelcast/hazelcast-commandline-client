...
You can xref:clc-job.adoc[create and manage] data pipelines using the Hazelcast CLC. Check out the Platform documentation for more information about data pipelines.
