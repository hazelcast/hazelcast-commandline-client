...
Using the Hazelcast CLC, you can xref:clc-viridian.adoc[create and manage] {hazelcast-cloud} clusters, and the custom classes on those clusters.

=== Create Data Pipelines

You can xref:clc-job.adoc[create and manage] data pipelines using the Hazelcast CLC. Check out xref:hazelcast:pipelines:overview.adoc[Platform documentation] for more information about data pipelines.
