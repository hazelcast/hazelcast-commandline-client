...
The Hazelcast CLC is a single binary with no dependencies. Within minutes of installation, you can start to perform common tasks on Viridian and Hazelast clusters.
...
Run xref:clc-snapshot.adoc[SQL] queries against your cluster and display the output as a table or in a variety of text formats, such as JSON and CSV.

=== Manage Viridian Clusters

Using CLC, you can xref:clc-viridian.adoc[create and manage] Viridian clusters and custom classes on those clusters.

=== Create Data Pipelines

You can xref:clc-job.adoc[create and manage] data pipelines using CLC. Check out the Platform documentation for more information about data pipelines.
