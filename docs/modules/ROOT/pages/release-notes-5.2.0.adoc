...
* Added the `--quite` (shorthand `-q`) flag which suppresses unnecessary outputs. Hazelcast CLC outputs can be noisy sometimes, such as success message logs. You can use this flag for a quieter output.
