...
const (
	MultiMapGetCodecRequestMessageType  = int32(0x020200)
	MultiMapGetCodecResponseMessageType = int32(0x020201)
...
func EncodeMultiMapGetRequest(name string, key iserialization.Data, threadId int64) *proto.ClientMessage {
	...
	EncodeLong(initialFrame.Content, MultiMapGetCodecRequestThreadIdOffset, threadId)
...
func DecodeMultiMapGetResponse(clientMessage *proto.ClientMessage) []*iserialization.Data {
