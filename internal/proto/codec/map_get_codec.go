...
const (
	MapGetCodecRequestMessageType  = int32(0x010200)
	MapGetCodecResponseMessageType = int32(0x010201)
...
func EncodeMapGetRequest(name string, key iserialization.Data, threadId int64) *proto.ClientMessage {
	...
	EncodeLong(initialFrame.Content, MapGetCodecRequestThreadIdOffset, threadId)
