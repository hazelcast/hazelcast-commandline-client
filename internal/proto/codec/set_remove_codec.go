...
const (
	SetRemoveCodecRequestMessageType  = int32(0x060500)
	SetRemoveCodecResponseMessageType = int32(0x060501)
...
func EncodeSetRemoveRequest(name string, value iserialization.Data) *proto.ClientMessage {
