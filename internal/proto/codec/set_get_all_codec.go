...
const (
	SetGetAllCodecRequestMessageType  = int32(0x060A00)
	SetGetAllCodecResponseMessageType = int32(0x060A01)
...
func DecodeSetGetAllResponse(clientMessage *proto.ClientMessage) []*iserialization.Data {
