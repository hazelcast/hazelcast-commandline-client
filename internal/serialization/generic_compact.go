...
func init() {
	fieldKindToType = map[serialization.FieldKind]int32{
		...
		serialization.FieldKindInt8:                         TypeByte,
		serialization.FieldKindArrayOfInt8:                  TypeByteArray,
		...
		serialization.FieldKindNullableInt8:                 TypeByte,
		serialization.FieldKindArrayOfNullableInt8:          TypeByteArray,
